...
import M_PAM_epy_block_0 as epy_block_0  # embedded python block
import math
import numpy as np
...
class M_PAM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "M_PAM")
        ...
        self.Rb = Rb = 32000
        self.Npbs = Npbs = int(math.log(M,2))
        self.Sps = Sps = len(h)
        self.Rs = Rs = Rb/Npbs
        ...
        self.blocks_vector_source_x_0 = blocks.vector_source_b((0, 0,1,1,1,0,1,1,0, 0,1,1,1,0,1,1), True, 1, [])
        self.blocks_pack_k_bits_bb_0 = blocks.pack_k_bits_bb(Npbs)
    ...
    def set_M(self, M):
        self.M = M
        self.set_Npbs(int(math.log(self.M,2)))
    ...
    def set_Rb(self, Rb):
        self.Rb = Rb
        self.set_Rs(self.Rb/self.Npbs)

    def get_Npbs(self):
        return self.Npbs

    def set_Npbs(self, Npbs):
        self.Npbs = Npbs
        self.set_Rs(self.Rb/self.Npbs)
...
def main(top_block_cls=M_PAM, options=None):
