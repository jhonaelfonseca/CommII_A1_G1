...
# Title: Laboratorio de 8PSK
# Author: Jeanpaull Valencia
# Description: Diseño de una modulación 8-PSK
...
import LABIV_epy_block_0 as epy_block_0  # embedded python block
import math
...
class LABIV(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Laboratorio de 8PSK", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Laboratorio de 8PSK")
        ...
        self.settings = Qt.QSettings("GNU Radio", "LABIV")
        ...
        self.connect((self.blocks_char_to_float_3, 0), (self.blocks_multiply_const_vxx_0, 0))
...
def main(top_block_cls=LABIV, options=None):
