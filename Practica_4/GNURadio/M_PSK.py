...
import M_PSK_epy_block_0 as epy_block_0  # embedded python block
import math
...
class M_PSK(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "M_PSK")
        ...
        widths = [3, 3, 1, 1, 1,
            1, 1, 1, 1, 1]
        colors = ['dark blue', 'cyan', 'green', 'black', 'cyan',
        ...
        self.blocks_repack_bits_bb_0 = blocks.repack_bits_bb(1, Npbs, "", False, gr.GR_LSB_FIRST)
    ...
    def set_Npbs(self, Npbs):
        self.Npbs = Npbs
        self.set_Rs(self.Rb/self.Npbs)
        self.blocks_repack_bits_bb_0.set_k_and_l(1,self.Npbs)
...
def main(top_block_cls=M_PSK, options=None):
