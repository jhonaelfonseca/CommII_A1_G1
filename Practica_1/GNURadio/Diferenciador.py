...
class Diferenciador(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.qtgui_time_sink_x_0.set_y_axis(-15, 100)
        ...
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_TRI_WAVE, (samp_rate/100), 10, 0, 0)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.analog_sig_source_x_0.set_frequency((self.samp_rate/100))
