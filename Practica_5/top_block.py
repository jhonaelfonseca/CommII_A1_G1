...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Variables
        ##################################################
        self.tabla_de_verdad_constelacion = tabla_de_verdad_constelacion = (-3+1j,-3+3j,-1+1j,-1+3j,1+1j,1+3j,3+1j,3+3j,-3-1j,-3-3j,-1-1j,-1-3j,1-1j,1-3j,3-1j,3-3j)
        self.M = M = len(tabla_de_verdad_constelacion )
        self.bps = bps = int(math.log(M,2))
        self.Sps = Sps = 16
        self.Rs = Rs = 32000
        self.samp_rate = samp_rate = Rs*Sps*40
        self.h = h = [1]*Sps
        self.fc = fc = 100e3
        self.Rb = Rb = Rs*bps
        ...
        self.analog_sig_source_x_0_0 = analog.sig_source_f((Rs*Sps), analog.GR_SIN_WAVE, fc, 1, 0, 0)
        self.analog_sig_source_x_0 = analog.sig_source_f((Rs*Sps), analog.GR_COS_WAVE, fc, 1, 0, 0)
        ...
        self.connect((self.blocks_add_xx_0_1, 0), (self.qtgui_time_sink_x_0_0, 0))
        ...
        self.connect((self.blocks_throttle2_0_0, 0), (self.blocks_add_xx_0_1, 1))
    ...
    def set_Sps(self, Sps):
        ...
        self.set_samp_rate(self.Rs*self.Sps*40)
        self.analog_sig_source_x_0.set_sampling_freq((self.Rs*self.Sps))
        self.analog_sig_source_x_0_0.set_sampling_freq((self.Rs*self.Sps))
